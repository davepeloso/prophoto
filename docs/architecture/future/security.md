...
Source: Archived package prophoto-security
Last reviewed: 2026-04
Purpose:
Magic link generation and verification, token lifecycle management, rate limiting, and abuse detection for passwordless subject access to galleries.

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- Magic link tokens are a prerequisite for prophoto-downloads and client-facing gallery access
