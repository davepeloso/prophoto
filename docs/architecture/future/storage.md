...
Source: Archived package prophoto-storage
Last reviewed: 2026-04
Purpose:
Unified storage abstraction layer supporting local (dev), ImageKit (production), and S3 drivers — with signed URL generation, path convention enforcement, and derivative management (thumb/preview/web).

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- prophoto-assets currently handles some storage concerns; review overlap before implementing this package
