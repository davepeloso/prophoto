...
Source: Archived package prophoto-tenancy
Last reviewed: 2026-04
Purpose:
Extended multi-tenancy features — studio context resolution from subdomain, organization context switching, and secure admin impersonation with audit trail. Note: Studio and Organization models are already implemented in prophoto-access.

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- Studio/Organization models and basic tenancy already live in prophoto-access. This spec covers advanced concerns: subdomain resolution middleware, multi-studio admin management, and impersonation.
