...
Source: Archived package prophoto-audit
Last reviewed: 2026-04
Purpose:
Comprehensive, event-driven activity logging and audit trail system. Listens to events from all packages to create a searchable, immutable record of "who did what, when, where, and why."

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- Consider evaluating spatie/laravel-activitylog before building custom
