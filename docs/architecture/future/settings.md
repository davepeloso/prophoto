...
Source: Archived package prophoto-settings
Last reviewed: 2026-04
Purpose:
Type-safe, hierarchical settings and feature flags system — studio-level defaults, organization-level overrides, runtime feature toggles with Filament admin UI.

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- Feature flags defined here (ai_portraits, booking, stripe_invoicing, bulk_download, etc.) should be referenced when deciding what to gate in active packages
