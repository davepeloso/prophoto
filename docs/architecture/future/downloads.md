...
Source: Archived package prophoto-downloads
Last reviewed: 2026-04
Purpose:
Async bulk ZIP download system with real-time progress tracking, expiring signed artifacts, and metadata/README inclusion in generated archives.

Notes:
- This is NOT an active package
- Do not implement without revisiting this spec
- Depends on prophoto-storage (storage abstraction) and prophoto-security (magic link auth) being built first
