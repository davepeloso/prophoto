{{-- Story 7.4 — Portrait Proofing Template --}}
{{-- Two-column tall portrait cards with Playfair Display + Lato fonts --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-950 text-white min-h-screen font-lato" x-data="proofingViewer()">
    ...
    <header class="bg-gray-900 border-b border-gray-800 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto text-center">
            <h1 class="font-playfair text-4xl sm:text-5xl font-light mb-4">{{ $gallery->subject_name }}</h1>
            <p class="text-gray-400 mb-2">{{ $share->confirmed_email }}</p>
            @if($share->message)
                <p class="text-gray-300 text-sm mb-6 max-w-2xl mx-auto">{{ $share->message }}</p>
            @endif
            ...
            <div class="mt-6 space-y-2">
                ...
                <div class="w-full max-w-xs mx-auto h-1 bg-gray-800 rounded-full overflow-hidden">
            ...
            <div class="mt-6">
                ...
                @else
                    <div class="inline-block px-6 py-2.5 text-sm font-medium bg-gray-800 text-gray-400 rounded-lg">
                        Submissions Locked
                    </div>
                @endif
            </div>
