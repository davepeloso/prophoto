...
class SessionAssociationEnumCoverageTest extends TestCase
{
    ...
    public function test_session_assignment_lock_effect_enum_contains_expected_values(): void
    {
        $values = array_map(
            static fn (SessionAssignmentLockEffect $effect): string => $effect->value,
            SessionAssignmentLockEffect::cases()
        );
